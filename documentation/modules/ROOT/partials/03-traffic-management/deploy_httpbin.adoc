...
image::03-traffic-management/httpbin_curl.png[httpbin service working,width="80%",align="center",link=../_images/03-traffic-management/httpbin_curl.png,window=_blank]
