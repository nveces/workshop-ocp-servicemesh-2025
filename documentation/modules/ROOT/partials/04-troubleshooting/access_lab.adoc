...
| <ocp_cluster_console>
| _https://console-openshift-console.apps.labs.sandbox1562.opentlc.com_
| Username
| <user>
| user1
| Password
...
| _apps.labs.sandbox1562.opentlc.com_
| Kiali Url
| <kiali_url>
| _https://kiali-istio-system.apps.labs.sandbox1562.opentlc.com_
|===
...
export OCP_APPS_DOMAIN=<openshift_apps_domain>
----
...
- <ocp_cluster_console> (_E.g. https://console-openshift-console.apps.labs.sandbox1562.opentlc.com_)

.Openshift Console Oauth
image:04-troubleshooting/ocp_console_oauth.png[link=../_images/04-troubleshooting/ocp_console_oauth.png,window=_blank]

.Openshift Console
image:04-troubleshooting/ocp_console.png[link=../_images/04-troubleshooting/ocp_console.png,window=_blank]
