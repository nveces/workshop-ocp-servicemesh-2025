...
** xref:07-observability/index.adoc#_lab_3_creating_a_tempostack[Lab 3 - Creating a TempoStack]
** xref:07-observability/index.adoc#_lab_4_openshift_service_mesh_and_tempo[Lab 4 - {ossm} and Tempo]
...
** xref:08-servicemesh-3.x/index.adoc#_lab_2_service_mesh_3_x_getting_started[Lab 2 - Service Mesh 3.x Getting Started]
