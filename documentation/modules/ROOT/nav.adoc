...
** xref:07-observability/index.adoc#_lab_1_install_tempo_operator[Lab 1 - Install Tempo Operator]
** xref:07-observability/index.adoc#_lab_2_install_red_hat_build_of_opentelemetry_operator[Lab 2 - Install Red Hat build of OpenTelemetry Operator]
** xref:07-observability/index.adoc#_lab_3_install_cluster_observability_operator[Lab 3 -  Install Cluster Observability Operator]
** xref:07-observability/index.adoc#_lab_3_creating_a_tempostack[Lab 4 - Creating a TempoStack]
** xref:07-observability/index.adoc#_lab_4_openshift_service_mesh_and_tempo[Lab 5 - {ossm} and Tempo]
