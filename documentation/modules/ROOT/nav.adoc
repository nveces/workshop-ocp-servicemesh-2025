...
** xref:01-setup.adoc#_platform[Platform]
** xref:01-setup.adoc#_openshift_cheat_sheet[OpenShift Cheat Sheet]
...
// ----------------------------------------------------------------
** xref:01-introduction/index.adoc#_lab_2_first_application_deployment[Lab 2 - First application deployment]
...
** xref:01-introduction/index.adoc#_lab_4_resources[Lab 4 - Resources]
** xref:01-introduction/index.adoc#_lab_5_liveness_and_readiness_probes[Lab 5 - Liveness and readiness probes]
** xref:01-introduction/index.adoc#_lab_6_network_policies[Lab 6 - Network Policies]
...
** xref:03-traffic-management/index.adoc#_lab_8_egress_gateways[Lab 8 - Egress Gateways]
** xref:03-traffic-management/index.adoc#_lab_9_grpc_routing[Lab 9 - gRPC Routing]
...
** xref:06-extensibility/index.adoc#_lab_2_webassembly_extensions[Lab 2 - {waes}]


* xref:07-observability/index.adoc[8. Observability - Labs]
** xref:07-observability/index.adoc#_lab_1_install_red_hat_build_of_opentelemetry_operator[Lab 1 - Install Red Hat build of OpenTelemetry Operator]
** xref:07-observability/index.adoc#_lab_2_install_opentelemetry_collector[Lab 2 -  Install OpenTelemetry Collector]
** xref:07-observability/index.adoc#_lab_3_install_tempo_operator[Lab 3 - Install Tempo Operator]
** xref:07-observability/index.adoc#_lab_4_creating_a_tempostack[Lab 4 - Creating a TempoStack]
** xref:07-observability/index.adoc#_lab_5_openshift_service_mesh_and_tempo[Lab 5 - {ossm} and Tempo]
** xref:07-observability/index.adoc#_lab_6_install_cluster_observability_operator[Lab 6 - Install Cluster Observability Operator]


* xref:08-servicemesh-3.x/index.adoc[9. Service Mesh 3.0]
//** xref:08-servicemesh-3.x/index.adoc#_lab_1_migration_from_2_x_to_3_x[Lab 1 - Migration from 2.x to 3.x]
** xref:08-servicemesh-3.x/index.adoc#_service_mesh_3_x_getting_started[ Service Mesh 3.x Getting Started]
