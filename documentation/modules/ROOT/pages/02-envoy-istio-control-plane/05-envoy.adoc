...
Please, visit this link https://istio.io/v1.6/docs/reference/config/networking/envoy-filter/[Envoy Filters,window=_blank] for more information about _envoy filters_.
