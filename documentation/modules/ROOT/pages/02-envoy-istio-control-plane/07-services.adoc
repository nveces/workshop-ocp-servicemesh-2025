...
TIP: Follow https://istio.io/v1.6/docs/tasks/traffic-management/ingress/secure-ingress/[Secure Ingress,window=_blank] for more information about generate certificates
