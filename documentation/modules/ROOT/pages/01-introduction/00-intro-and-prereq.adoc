...
image:introduction/login.png[login,link=../_images/introduction/login.png,window=_blank]
...
image:introduction/empty-projects.png[empty-projects,link=../_images/introduction/empty-projects.png,window=_blank]
