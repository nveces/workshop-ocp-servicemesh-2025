...
NOTE: We will refer to this new project as *YOUR-EXTERNAL-PROJECT* and the previous one as *YOUR_REGULAR_PROJECT*
...
----
$ oc apply -f $LABS_HOME/app-deployment.yaml -n <YOUR-EXTERNAL-PROJECT>
...
....
$ curl -v quarkus-petclinic.<YOUR_REGULAR_PROJECT>.svc:8080 | grep 200
....

You can take the hostname of your service as follows:

image::01-introduction/service.png[service,link=../_images/01-introduction/service.png,window=_blank]
...
....
$ oc apply -f $LABS_HOME/np-same-project.yaml -n <YOUR_REGULAR_PROJECT>
...
....
$ oc apply -f $LABS_HOME/allow-openshift-ingress.yaml -n <YOUR_REGULAR_PROJECT>
