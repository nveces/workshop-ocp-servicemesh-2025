= Lab 2 - First application deployment
:imagesdir: ./images
:toc: left
...
----
$ oc apply -f $LABS_HOME/app-deployment.yaml -n <YOUR_PROJECT>
...
....
$ oc apply -f $LABS_HOME/app-service.yaml -n <YOUR_PROJECT>
...
....
$ oc apply -f $LABS_HOME/app-route.yaml -n <YOUR_PROJECT>
