...
- https://kubernetes.io/docs/concepts/configuration/configmap/[ConfigMaps,window=_blank]
- https://kubernetes.io/docs/concepts/configuration/secret/[Secrets,window=_blank]
