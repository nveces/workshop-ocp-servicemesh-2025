...
image::bookinfo_curl.png[]

include::partials/kiali_traffic.adoc[leveloffset=+1]

Now, this is how the {ig} looks like in Kiali:

.Bookinfo productpage service through an {ig}
image::ingress_bookinfo.png[]

include::partials/remove_bookinfo.adoc[leveloffset=+2]
...
include::partials/remove_httpbin.adoc[leveloffset=+2]
