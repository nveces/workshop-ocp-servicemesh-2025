...
You can do more things like load balancing, ejecting with consecutive 500 errors, and more. If you want to learn more, check the link:{istio_doc}/reference/config/networking/destination-rule[Destination Rule,window=_blank] page at Istio.
...
image::03-traffic-management/fortio-4-30.png[link=../_images/03-traffic-management/fortio-4-30.png,window=_blank]
