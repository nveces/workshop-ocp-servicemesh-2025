...
export OCP_NAMESPACE="${OCP_USER}-namespace"
export OCP_API="https://api.ocp.sandbox2865.opentlc.com:6443"
export OCP_DOMAIN="apps.ocp.sandbox2865.opentlc.com"
export OCP_BOOKINFO_HOST="${OCP_USER}.bookinfo.${OCP_DOMAIN}"
export OCP_HTTPBIN_HOST="${OCP_USER}.httpbin.${OCP_DOMAIN}"
----
...
- <ocp_cluster_console> (_E.g. {ocp_cluster_console}_)
...
[source,bash, subs="+macros,+attributes"]
----
git clone https://github.com/nveces/ocp-servicemesh-labs-2025.git <YOUR-SELECTED-FOLDER>
----

It is recommended to update a variable called *LABS_HOME* as follows:

----
export LABS_HOME=<YOUR-SELECTED-FOLDER>/lab-03
----
