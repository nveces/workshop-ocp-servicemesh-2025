...
POD=$(oc get pod -o jsonpath='{.items[0].metadata.name}' -n openshift-ingress)
oc rsh $POD
----
...
.HTTP Response 503 returned by curl command
...
.HTTP Response 503 returned by Firefox browser
image::04-troubleshooting/jump-app-trou-04-gw-ok-503.png[link=../_images/04-troubleshooting/jump-app-trou-04-gw-ok-503.png,window=_blank]
...
.Kiali Console Virtual Service Error
image::04-troubleshooting/jump-app-kiali-trou-04-error-vs-01.png[link=../_images/04-troubleshooting/jump-app-kiali-trou-04-error-vs-01.png,window=_blank]

IMPORTANT: If you take a look at the host paths closely you can find a bad definition because of the pattern *"-fail"* included in the path. Please, modify this hostname and click on *[ SAVE ]*.

.Kiali Console Virtual Service Fixed
image::04-troubleshooting/jump-app-kiali-trou-04-fixed-vs.png[link=../_images/04-troubleshooting/jump-app-kiali-trou-04-fixed-vs.png,window=_blank]
...
.Kiali Console Destination Rule Error
image::04-troubleshooting/jump-app-kiali-trou-04-error-dr-01.png[link=../_images/04-troubleshooting/jump-app-kiali-trou-04-error-dr-01.png,window=_blank]


IMPORTANT: Lastly, if you take a look at the label version you can find a bad definition. Please, replace *fail* with *v1* version and click on *[ SAVE ]*.

.Kiali Console DestinationRule Fixed
image::04-troubleshooting/jump-app-kiali-trou-04-fixed-dr-01.png[link=../_images/04-troubleshooting/jump-app-kiali-trou-04-fixed-dr-01.png,window=_blank]
...
At this time, _Jump App_ is generating traffic flow thanks to the frontend where it was given an specific number of continuous jumps. In order to review the Service Mesh traffic flow in your project, please visit the Kiali console *{kiali_url}[window=_blank]*:
