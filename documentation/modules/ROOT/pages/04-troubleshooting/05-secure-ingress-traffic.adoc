...
.Edit the route
image::04-troubleshooting/jump-app-trou-05-gw-fixed-01.png[link=../_images/04-troubleshooting/jump-app-trou-05-gw-fixed-01.png,window=_blank]

.Change to https secure port
image::04-troubleshooting/jump-app-trou-05-gw-fixed-02.png[link=../_images/04-troubleshooting/jump-app-trou-05-gw-fixed-02.png,window=_blank]

.Save the route
image::04-troubleshooting/jump-app-trou-05-gw-fixed-03.png[link=../_images/04-troubleshooting/jump-app-trou-05-gw-fixed-03.png,window=_blank]
