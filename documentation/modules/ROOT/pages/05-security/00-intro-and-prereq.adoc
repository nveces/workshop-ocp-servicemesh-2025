...
- *$APPS_NS1* and *$APPS_NS2* : namespaces where you will deploy your apps during the whole series of labs. Ex: `user24-sm` and `user24-sm-mesh-external`
...
// - *$INGRESS_GW*: every user will have a dedicated Ingress Gateway to manage his/her ingress traffic. Ex: `user24-ingress`
- *$INGRESS_GW*: `istio-ingressgateway`
- *$PRODUCTPAGE_HOST*: external domain for the productpage service. Ex: `productpage-user24-sm.apps.ocp.sandbox2790.opentlc.com`
...
https://github.com/nveces/ocp-servicemesh-labs-2025.git

Clone the repository to your desired location, that will then be referred as *$LABS_HOME* during the labs:

....
$ git clone https://github.com/nveces/ocp-servicemesh-labs-2025.git $LABS_HOME
....
...
image::05-security/kiali-projects.png[Kiali mesh and namespaces,link=../_images/05-security/kiali-login.png,window=_blank]
