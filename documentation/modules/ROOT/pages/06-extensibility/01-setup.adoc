...
| <ocp_cluster_api>
| _{ocp_cluster_api}[window=_blank]_
| OpenShift Web Console
| <ocp_cluster_console>
| _{ocp_cluster_console}[window=_blank]_
| Username
| <user>
| _user1_
| Password
...
export OCP_NAMESPACE="${OCP_USER}-sm"
export OCP_API="{ocp_cluster_api}"
export OCP_DOMAIN="{ocp_apps_domain}"
...
[source,bash,subs="+macros,+attributes"]
----
export OCP_USER="user01"
export OCP_PASSWORD="user01"
export OCP_NAMESPACE="${OCP_USER}-sm"
export OCP_API="{ocp_cluster_api}"
export OCP_DOMAIN="{ocp_apps_domain}"
export OCP_HTTPBIN_HOST="${OCP_USER}.httpbin.${OCP_DOMAIN}"
...
- <ocp_cluster_console> (_E.g. {ocp_cluster_console}[window=_blank]_)
...
[source,bash, subs="+macros,+attributes"]
----
cd ocp-servicemesh-labs-2025/lab-06
----
